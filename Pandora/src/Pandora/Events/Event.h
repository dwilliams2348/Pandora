...
namespace Pandora {
	/*
	Events in Pandora are currently blocking events, which means when the event occurs it
	...
	*/
	...
	/*
	There are different event types that take place in the Pandora event system.
...
#define EVENT_CLASS_CATEGORY(category) virtual int GetCategoryFlags() const override {return category;}
	...
	public:
		...
		//Dispatches a function for a given event, function must return a bool
		template<typename T>
